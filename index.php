...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/polibk/dist/css/welcome_styles.css">
</head>

<body>
    <!-- Responsive navbar-->
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #346eeb;">
    ...
    ?>
        <!-- Header-->
        <header class="py-5" style="background-color: #346eeb;"> <!-- Ubah Color Banner disini -->
            <div class="container px-5">
